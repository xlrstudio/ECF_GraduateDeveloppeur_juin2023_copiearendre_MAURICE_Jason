 ...
 */
final class Version20230206094315 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE message ADD titre VARCHAR(255) NOT NULL, ADD email VARCHAR(255) NOT NULL, DROP title, DROP user_email');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE message ADD title VARCHAR(255) NOT NULL, ADD user_email VARCHAR(255) NOT NULL, DROP titre, DROP email');
    }
}
