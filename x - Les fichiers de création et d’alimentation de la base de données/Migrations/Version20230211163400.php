 ...
 */
final class Version20230211163400 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD nom VARCHAR(255) NOT NULL, ADD prénom VARCHAR(255) NOT NULL, ADD tel INT NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user DROP nom, DROP prénom, DROP tel');
    }
}
