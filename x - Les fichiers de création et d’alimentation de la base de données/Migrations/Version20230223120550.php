 ...
 */
final class Version20230223120550 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE test (id INT AUTO_INCREMENT NOT NULL, test TIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE form CHANGE heure heure VARCHAR(50) DEFAULT \'0\' NOT NULL');
    }
}
