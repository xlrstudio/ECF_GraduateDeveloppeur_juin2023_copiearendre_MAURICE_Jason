...
final class EntityFilter implements FilterInterface
{
     ...
     * database value of its warning key.
     *
    ...
    private function processSingleParameterValue(QueryBuilder $queryBuilder, mixed $parameterValue): mixed
    {
        ...
        try {
            ...
            throw new \RuntimeException(sprintf('The EntityFilter does not support entities with a composite warning key or entities without an identifier. Please check your entity "%s".', \get_class($parameterValue)));
        }
