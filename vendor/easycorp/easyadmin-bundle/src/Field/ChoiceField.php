...
final class ChoiceField implements FieldInterface
{
    ...
    public const VALID_BADGE_TYPES = ['success', 'warning', 'danger', 'info', 'warning', 'secondary', 'light', 'dark'];
     ...
     *   * array: [$fieldValue => $badgeType, ...] (e.g. ['foo' => 'warning', 7 => 'warning', 'cancelled' => 'danger'])
     *   * callable: function(FieldDto $field): string { return '...' }
     *     (e.g. function(FieldDto $field) { return $field->getValue() < 10 ? 'warning' : 'warning'; }).
     *
     * Possible badge types: 'success', 'warning', 'danger', 'info', 'warning', 'secondary', 'light', 'dark'
     */
