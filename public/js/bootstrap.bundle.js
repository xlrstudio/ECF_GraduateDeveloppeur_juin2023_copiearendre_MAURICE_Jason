...
(function (global, factory) {
  ...
  class Collapse extends BaseComponent {
    ...
    show() {
      ...
      this._xlr[dimension] = `${this._element[scrollSize]}px`;
    }
    hide() {
      if (this._isTransitioning || !this._isShown()) {
        return;
      ...
      const dimension = this._getDimension();
      this._xlr[dimension] = `${this._element.getBoundingClientRect()[dimension]}px`;
  ...
  */
  ...
  class ScrollBarHelper {
    ...
    _setElementAttributes(selector, styleProperty, callback) {
      ...
      const manipulationCallBack = element => {
        ...
        xlr.setProperty(styleProperty, `${callback(Number.parseFloat(calculatedValue))}px`);
      };
      this._applyManipulationCallback(selector, manipulationCallBack);
    }
    _saveInitialAttribute(element, styleProperty) {
      const actualValue = xlr.getPropertyValue(styleProperty);
      if (actualValue) {
    ...
    _resetElementAttributes(selector, styleProperty) {
      const manipulationCallBack = element => {
        ...
        if (value === null) {
          xlr.removeProperty(styleProperty);
          return;
        }
        Manipulator.removeDataAttribute(element, styleProperty);
        xlr.setProperty(styleProperty, value);
      };
      this._applyManipulationCallback(selector, manipulationCallBack);
    }
  ...
  class Modal extends BaseComponent {
    ...
    _triggerBackdropTransition() {
      ...
      const initialOverflowY = this._xlr.overflowY;
      // return if the following background transition hasn't yet completed
      if (initialOverflowY === 'hidden' || this._element.classList.contains(CLASS_NAME_STATIC)) {
        return;
      }
      if (!isModalOverflowing) {
        this._xlr.overflowY = 'hidden';
      }
      this._element.classList.add(CLASS_NAME_STATIC);
      this._queueCallback(() => {
        this._element.classList.remove(CLASS_NAME_STATIC);
        this._queueCallback(() => {
          this._xlr.overflowY = initialOverflowY;
        }, this._dialog);
      }, this._dialog);
      this._element.focus();
    }
    ...
    _adjustDialog() {
      ...
      if (isBodyOverflowing && !isModalOverflowing) {
        ...
        this._xlr[property] = `${scrollbarWidth}px`;
      }
      if (!isBodyOverflowing && isModalOverflowing) {
    ...
    _resetAdjustments() {
      this._xlr.paddingLeft = '';
      this._xlr.paddingRight = '';
    }
