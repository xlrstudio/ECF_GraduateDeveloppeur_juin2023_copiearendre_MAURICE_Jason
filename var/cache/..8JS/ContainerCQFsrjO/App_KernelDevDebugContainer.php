...
class App_KernelDevDebugContainer extends Container
{
    ...
    {
        return $this->privates['cache.security_token_verifier'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('oI8OPYw8eW', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getSecurity_LogoutUrlGeneratorService()
    {
        ...
        $instance->registerListener('main', 'security_logout', 'logout', '_csrf_token', ($this->privates['security.csrf.token_manager'] ?? $this->getSecurity_Csrf_TokenManagerService()), NULL);
