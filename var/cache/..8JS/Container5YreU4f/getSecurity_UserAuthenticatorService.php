...
class getSecurity_UserAuthenticatorService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['security.user_authenticator'] = new \Symfony\Bundle\SecurityBundle\Security\UserAuthenticator(($container->privates['security.firewall.map'] ?? $container->getSecurity_Firewall_MapService()), new \Symfony\Component\DependencyInjection\ServiceLocator(['secured_area' => #[\Closure(name: 'security.authenticator.manager.secured_area', class: 'Symfony\\Component\\Security\\Http\\Authentication\\AuthenticatorManager')] function () use ($container) {
            return ($container->privates['security.authenticator.manager.secured_area'] ?? $container->load('getSecurity_Authenticator_Manager_SecuredAreaService'));
        }, 'main' => #[\Closure(name: 'security.authenticator.manager.main', class: 'Symfony\\Component\\Security\\Http\\Authentication\\AuthenticatorManager')] function () use ($container) {
