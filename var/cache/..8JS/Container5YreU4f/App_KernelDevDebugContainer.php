...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\LoginAdminController' => 'getLoginAdminControllerService',
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('0IrHh5VveZ', 0, ($this->targetDir.''.'/pools/app'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true));
    ...
    /**
     * Gets the private '.service_locator.gCQTnMM' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_GCQTnMMService()
    {
        return $this->privates['.service_locator.gCQTnMM'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
    ...
    protected function getEntityFactoryService()
    {
        ...
        }, 28)), ($this->privates['EasyCorp\\Bundle\\EasyAdminBundle\\Factory\\ActionFactory'] ?? $this->getActionFactoryService()), $a, ($this->services['doctrine'] ?? $this->getDoctrineService()), $b);
    }
    ...
    protected function getSecurity_ContextListener_0Service()
    {
        ...
        }, 1), 'secured_area', ($this->privates['monolog.logger.security'] ?? $this->getMonolog_Logger_SecurityService()), ($this->privates['security.event_dispatcher.secured_area'] ?? $this->getSecurity_EventDispatcher_SecuredAreaService()), ($this->privates['security.authentication.trust_resolver'] ??= new \Symfony\Component\Security\Core\Authentication\AuthenticationTrustResolver()), [0 => ($this->privates['security.token_storage'] ?? $this->getSecurity_TokenStorageService()), 1 => 'enableUsageTracking']);
    }
    ...
    {
        return $this->privates['security.context_listener.1'] = new \Symfony\Component\Security\Http\Firewall\ContextListener(($this->privates['security.untracked_token_storage'] ??= new \Symfony\Component\Security\Core\Authentication\Token\Storage\TokenStorage()), new RewindableGenerator(function () {
            yield 0 => ($this->privates['security.user.provider.concrete.app_user_provider'] ?? $this->load('getSecurity_User_Provider_Concrete_AppUserProviderService'));
    ...
    protected function getSecurity_EventDispatcher_SecuredAreaService()
    {
        ...
        $instance->addListener('Symfony\\Component\\Security\\Http\\Event\\LoginSuccessEvent', [0 => #[\Closure(name: 'security.listener.session.secured_area', class: 'Symfony\\Component\\Security\\Http\\EventListener\\SessionStrategyListener')] function () {
            return ($this->privates['security.listener.session.secured_area'] ?? $this->load('getSecurity_Listener_Session_SecuredAreaService'));
        }, 1 => 'onSuccessfulLogin'], 0);
        $instance->addListener('Symfony\\Component\\Security\\Http\\Event\\LogoutEvent', [0 => #[\Closure(name: 'security.logout.listener.default.secured_area', class: 'Symfony\\Component\\Security\\Http\\EventListener\\DefaultLogoutListener')] function () {
            return ($this->privates['security.logout.listener.default.secured_area'] ?? $this->load('getSecurity_Logout_Listener_Default_SecuredAreaService'));
        }, 1 => 'onLogout'], 64);
        $instance->addListener('Symfony\\Component\\Security\\Http\\Event\\LogoutEvent', [0 => #[\Closure(name: 'security.logout.listener.session.secured_area', class: 'Symfony\\Component\\Security\\Http\\EventListener\\SessionLogoutListener')] function () {
            return ($this->privates['security.logout.listener.session.secured_area'] ??= new \Symfony\Component\Security\Http\EventListener\SessionLogoutListener());
        }, 1 => 'onLogout'], 0);
        $instance->addListener('Symfony\\Component\\Security\\Http\\Event\\CheckPassportEvent', [0 => #[\Closure(name: 'security.listener.user_checker.secured_area', class: 'Symfony\\Component\\Security\\Http\\EventListener\\UserCheckerListener')] function () {
        ...
        $instance->addListener('security.authentication.success', [0 => #[\Closure(name: 'security.listener.user_checker.secured_area', class: 'Symfony\\Component\\Security\\Http\\EventListener\\UserCheckerListener')] function () {
            return ($this->privates['security.listener.user_checker.secured_area'] ?? $this->load('getSecurity_Listener_UserChecker_SecuredAreaService'));
        }, 1 => 'postCheckCredentials'], 256);
        $instance->addListener('Symfony\\Component\\Security\\Http\\Event\\CheckPassportEvent', [0 => #[\Closure(name: 'security.listener.user_provider', class: 'Symfony\\Component\\Security\\Http\\EventListener\\UserProviderListener')] function () {
            return ($this->privates['security.listener.user_provider'] ?? $this->load('getSecurity_Listener_UserProviderService'));
    ...
    {
        $a = ($this->privates['.service_locator.gCQTnMM'] ?? $this->get_ServiceLocator_GCQTnMMService());
    ...
    protected function getSecurity_LogoutUrlGeneratorService()
    {
        ...
        $instance->registerListener('secured_area', 'app_logout', 'logout', '_csrf_token', NULL, NULL);
    ...
    protected function getTwigService()
    {
        ...
        $h = new \Symfony\WebpackEncoreBundle\Twig\StimulusTwigExtension();
        ...
        $instance->addExtension(new \Symfony\UX\Chartjs\Twig\ChartExtension($h));
