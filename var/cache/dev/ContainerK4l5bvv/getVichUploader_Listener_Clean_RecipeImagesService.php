 ...
 */
class getVichUploader_Listener_Clean_RecipeImagesService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'vich_uploader.listener.clean.recipe_images' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['vich_uploader.listener.clean.recipe_images'])) {
            return $container->privates['vich_uploader.listener.clean.recipe_images'];
        }

        return $container->privates['vich_uploader.listener.clean.recipe_images'] = new \Vich\UploaderBundle\EventListener\Doctrine\CleanListener('recipe_images', ($container->privates['vich_uploader.adapter.orm'] ??= new \Vich\UploaderBundle\Adapter\ORM\DoctrineORMAdapter()), ($container->privates['vich_uploader.metadata_reader'] ?? $container->getVichUploader_MetadataReaderService()), $a);
    }
}
