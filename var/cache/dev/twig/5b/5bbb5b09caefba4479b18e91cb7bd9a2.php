...
class __TwigTemplate_f954cd67f49893bb952bb75bc30f5234 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    public function macro_dump_request_data($__token__ = null, $__events__ = null, $__origin__ = null, ...$__varargs__)
    {
        ...
        try {
            ...
            // line 162
            $macros["__internal_parse_9"] = $this;
            // line 163
            echo "{
    id: \"";
            // line 164
    ...
    events: [ ";
            // line 167
            echo twig_call_macro($macros["__internal_parse_9"], "macro_dump_events", [(isset($context["events"]) || array_key_exists("events", $context) ? $context["events"] : (function () { throw new RuntimeError('Variable "events" does not exist.', 167, $this->source); })())], 167, $context, $this->getSourceContext());
            echo " ],
}
";
...
{% endmacro %}
", "@WebProfiler/Collector/time.html.twig", "C:\\xampp\\apps\\symfony\\vendor\\symfony\\web-profiler-bundle\\Resources\\views\\Collector\\time.html.twig");
    }
}
