...
class __TwigTemplate_46b94f2e697ab2fdc5a6da51bdd098ef extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    <table class=\"table\">
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["figures"]) || array_key_exists("figures", $context) ? $context["figures"] : (function () { throw new RuntimeError('Variable "figures" does not exist.', 17, $this->source); })()));
...
{% block body %}
    ...
    <table class=\"table\">
        ...
        {% for figure in figures %}
            <tr>
                ...
                <td>{{ figure.name }}</td>
                <td>
                    <a href=\"{{ path('app_figure_show', {'id': figure.id}) }}\">show</a>
    ...
    <a href=\"{{ path('app_figure_new') }}\">Create new</a>
{% endblock %}
", "figure/index.html.twig", "C:\\xampp\\apps\\symfony\\templates\\figure\\index.html.twig");
    }
}
