...
class getDoctrine_FixturesLoadCommandService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'DataFixtures'.\DIRECTORY_SEPARATOR.'CategoryTagFixtures.php';
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'DataFixtures'.\DIRECTORY_SEPARATOR.'CommentFixtures.php';
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'DataFixtures'.\DIRECTORY_SEPARATOR.'LikeFixtures.php';
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'DataFixtures'.\DIRECTORY_SEPARATOR.'PostFixtures.php';
        ...
        $b = ($container->privates['App\\Repository\\Post\\PostRepository'] ?? $container->load('getPostRepositoryService'));
        $c = ($container->privates['App\\Repository\\UserRepository'] ?? $container->load('getUserRepositoryService'));

        $a->addFixtures([0 => ['fixture' => new \App\DataFixtures\AppFixtures(), 'groups' => []], 1 => ['fixture' => new \App\DataFixtures\CategoryTagFixtures($b), 'groups' => []], 2 => ['fixture' => new \App\DataFixtures\CommentFixtures($b, $c), 'groups' => []], 3 => ['fixture' => new \App\DataFixtures\LikeFixtures($b, $c), 'groups' => []], 4 => ['fixture' => new \App\DataFixtures\PostFixtures(), 'groups' => []], 5 => ['fixture' => new \App\DataFixtures\UserFixtures(($container->privates['security.user_password_hasher'] ?? $container->load('getSecurity_UserPasswordHasherService'))), 'groups' => []]]);
